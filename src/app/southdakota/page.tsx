...
export default function SouthDakotaPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800 text-white">
      ...
      {/* Reviews Section */}
      <section id="reviews" className="py-20 bg-gradient-to-br from-purple-900/50 to-indigo-900/30">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {reviews.map((review, index) => (
              <div 
                key={index}
                className="bg-gradient-to-br from-purple-800/30 to-indigo-800/20 backdrop-blur-sm border border-purple-500/20 rounded-xl p-6 hover:border-purple-400/40 transition-all duration-300 hover:transform hover:scale-[1.02]"
              >
                ...
                <blockquote className="text-gray-100 text-lg mb-6 leading-relaxed">
                  &quot;{review.text}&quot;
                </blockquote>
                ...
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-purple-300 font-medium">{review.author}</span>
                  </div>
                  <span className="text-gray-400 bg-purple-800/30 px-3 py-1 rounded-full">
                    {review.platform}
                  </span>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-pink-900/30 to-purple-900/40">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-12">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-8">
                เราอยากรู้ความรู้สึกของคุณ! แค่ไม่กี่บรรทัดก็เพียงพอ<br/>
                มาร่วมเป็นส่วนหนึ่งของชุมชนนักอ่าน #southdakota18 กันเถอะ
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8 mb-12">
              {/* Email Review */}
              <div className="bg-gradient-to-br from-purple-800/40 to-pink-800/30 backdrop-blur-sm border border-purple-400/30 rounded-2xl p-8 hover:border-purple-300/50 transition-all duration-300 group hover:scale-[1.02]">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-3">ส่งรีวิวส่วนตัว</h3>
                ...
                <a href="mailto:story@mail.playground.chidahp.com?subject=รีวิว South Dakota 18%2B&body=สวัสดีครับ/ค่า%0A%0Aผมได้อ่าน South Dakota 18%2B จบแล้ว และอยากแชร์ความรู้สึกดังนี้%3A%0A%0A" className="inline-block bg-gradient-to-r from-purple-600 to-pink-600 px-8 py-3 rounded-full text-white font-medium hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105">
                  เขียนรีวิวทางอีเมล์
                </a>
              </div>

              {/* Social Media Review */}
              <div className="bg-gradient-to-br from-indigo-800/40 to-purple-800/30 backdrop-blur-sm border border-purple-400/30 rounded-2xl p-8 hover:border-purple-300/50 transition-all duration-300 group hover:scale-[1.02]">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-3">แชร์บน Social Media</h3>
                  <p className="text-gray-300 leading-relaxed mb-6">
                ...
                <button 
                  className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-3 rounded-full text-white font-medium hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105"
                  onClick={() => {
                    if (navigator.share) {
                      navigator.share({
